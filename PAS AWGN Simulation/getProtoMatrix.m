%==========================================================================
% 802.11 QC-LDPC Parity Check Matrix Configuration
%==========================================================================
% Description:
%   Returns LDPC encoder and decoder configuration objects for 802.11
%   quasi-cyclic LDPC codes. Supports various block lengths and code rates.
%
% Inputs:
%   block_length - LDPC codeword length (648, 1296, or 1944)
%   num_info - Number of information bits (determines code rate)
%
% Outputs:
%   cfgLDPCEnc - LDPC encoder configuration object
%   cfgLDPCDec - LDPC decoder configuration object (BP decoding)
%
% Examples:
%   [cfgEnc, cfgDec] = getProtoMatrix(1944, 972);   % Rate 1/2
%   [cfgEnc, cfgDec] = getProtoMatrix(1944, 1296);  % Rate 2/3
%

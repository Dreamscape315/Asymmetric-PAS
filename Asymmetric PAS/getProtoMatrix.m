%==========================================================================
% Get LDPC Protograph Matrix Configuration
%==========================================================================
% Description:
%   Returns LDPC encoder and decoder configuration objects for specified
%   block length and information bit count. Uses IEEE 802.11n standard
%   protograph matrices.
%
% Inputs:
%   block_length - LDPC codeword length (648, 1296, or 1944)
%   num_info - Number of information bits
%
% Outputs:
%   cfgLDPCEnc - LDPC encoder configuration object
%   cfgLDPCDec - LDPC decoder configuration object (belief propagation)
%
...
function [cfgLDPCEnc, cfgLDPCDec] = getProtoMatrix(block_length, num_info)
    X = -1;  % Placeholder for empty positions in protograph
    ...
    % Construct LDPC parity-check matrix from protograph
